...
export const AUDIT_ACTIONS = {
  ...
  EMPLOYEE_ADDED: "Funcionário(a) cadastrado(a)",
  EMPLOYEE_UPDATED: "Funcionário(a) alterado(a)",
  EMPLOYEE_REMOVED: "Funcionário(a) removido(a)",
  EMPLOYEE_RESTORED: "Funcionário(a) de volta à lista",
