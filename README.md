...
- **Funcionários do SINDSERM** (Painel → Funcionários SINDSERM, só administrador; nunca pelo link público): liberados um a um ou colando a lista (`Nome; Setor; Convidado`). Cada um tem **voucher próprio** (dourado, "passe da casa", diferente do voucher de filiado), **1 kit** e pode levar **1 convidado**, com as mesmas regras do convidado de professor(a) (o kit do convidado sai depois que o funcionário chegar). Os kits dos dois saem do **estoque dos funcionários**, separado. Uma pessoa não pode ser, ao mesmo tempo, funcionária e filiada ou convidada. Tirar da lista cancela o voucher e o convite do convidado.
